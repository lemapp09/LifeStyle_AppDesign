...
namespace AppDesign
{
    public class SportsUIManager : MonoBehaviour
    {
        ...
        public void SetSportsContainer(VisualElement container)
        {
            _sportsContainer = container;
        }
        
        public void PopulateSports(NewsArticle[] articles)
        {
            if (articles == null) return;
            int newsCount = 0;
            _sportsContainer.Clear();
            foreach (var article in articles)
            {
                ...
                _sportsContainer.Add(articleElement);
            }
        }
